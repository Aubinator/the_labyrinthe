...
int questionnaire(SDL_Surface *ecran){
	srand(time(NULL));
	quest str[9];
	str[0].quest ="Le plus celebre des sorciers ?";
	...
	str[3].rep1 = "sady";
	str[3].rep2 = "On est ou la?";
	str[3].rep3 = "Moi meme bien sur";
	str[3].brep = 1;
	str[4].quest = "Le plus haut sommet de chine ?";
	str[4].rep1 = "l'everest";
	str[4].rep2 ="le kilipuko";
	str[4].rep3 ="le mont fuji";
	str[4].brep = 3;
	str[5].quest = "Que veut dire RTFM ?";
	...
	str[7].rep3 = "un film";
	str[7].brep = 3;
	str[8].quest = "Qu'est ce qui dope  Belly ?";
	str[8].rep1 = "du bouye";
	...
	SDL_Color couleur = {0, 0, 0}, couleur2 = {71, 81, 213};
